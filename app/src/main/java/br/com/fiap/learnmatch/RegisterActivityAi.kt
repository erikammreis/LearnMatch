...
class RegisterActivityAi : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_register_a_i_student)
        setupViews()
        registerAiNext.setOnClickListener {
            val intent = Intent(this@RegisterActivityAi, RegisterActivityMC::class.java)
    ...
    private fun setupViews() {
        ...
        registerAiNext = findViewById(R.id.registerAiNext)
